...
[![npm](https://img.shields.io/npm/v/maize-api.svg?style=flat-square)](https://registry.npmjs.org/maize-api)

## Usage example

```js
const { readFileSync } = require('fs');
const { Connection, constants, ApiClient } = require('maize-api');

(async () => {
  const conn = new Connection('localhost:55410', {
...
A Changelog can be found [here](https://github.com/MinerGreggy/maize-api/blob/master/CHANGELOG.md)

## License

GNU GPLv3 (see [LICENSE](https://github.com/MinerGreggy/maize-api/blob/master/LICENSE))
